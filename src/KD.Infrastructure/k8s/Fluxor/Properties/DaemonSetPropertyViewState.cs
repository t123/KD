...
public record FetchKubernetesDaemonSetPropertyAction(TabModel Tab, CancellationToken CancellationToken = default) : FetchKubernetesGenericPropertyAction<DaemonSetPropertyViewModel>(Tab, CancellationToken);
