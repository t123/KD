namespace KD.Infrastructure.k8s.ViewModels.Objects;
...
public record ContainerViewModel(string ContainerId, string Name, bool Started, string State, int RestartCount, int? ExitCode);
public record PortViewModel(int Port, string Protocol, string Name);
public record AddressViewModel(string Ip, string Hostname);

public record NodeViewModel(string Uid, string Name, string Namespace, DateTime? Created) : IObjectViewModel;
...
public record NamespaceViewModel(string Uid, string Name, string Namespace, DateTime? Created, string Status) : IObjectViewModel;
...
public record DeploymentViewModel(string Uid, string Name, string Namespace, int? Replicas, int? ReadyReplicas, int? AvailableReplicas, int? UnavailableReplicas, int? UpdatedReplicas, int? TerminatingReplicas, DateTime? Created) : IObjectViewModel;
...
public record EndpointViewModel(string Uid, string Name, string Namespace, DateTime? Created, PortViewModel[] Ports, AddressViewModel[] Ready, AddressViewModel[] NotReady) : IObjectViewModel;
