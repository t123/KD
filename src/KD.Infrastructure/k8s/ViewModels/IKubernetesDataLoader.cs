...
internal interface IKubernetesDataLoader
{
    ...
    Task<V1HorizontalPodAutoscalerList> GetHorizontalPodAutoscalers(Context context, string[] namespaces, CancellationToken cancellationToken);
    ...
    Task<V1MutatingWebhookConfigurationList> GetMutatingWebhookConfiguration(Context context, string[] namespaces, CancellationToken cancellationToken);
