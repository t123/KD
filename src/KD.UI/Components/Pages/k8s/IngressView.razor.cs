...
public partial class IngressView : BaseView
{
    ...
    private void OpenProperties(IngressViewModel viewModel)
    {
        ...
        Dispatcher.Dispatch(new FetchKubernetesIngressPropertyAction(Tab, viewModel.Name, viewModel.Namespace, _cancellationTokenSource.Token));
    }
    ...
    {
        Dispatcher.Dispatch(new OpenEditorAction(tab, name, ns, ObjectType.Ingress));
    }
}