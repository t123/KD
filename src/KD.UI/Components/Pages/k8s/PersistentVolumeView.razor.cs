...
public partial class PersistentVolumeView : BaseView
{
    ...
    {
        Dispatcher.Dispatch(new FetchKubernetesPersistentVolumeAction(Tab, NamespacesState.Value.SelectedNamespaces, _cancellationTokenSource.Token));
    }

    private async Task ContextMenuClick(DataGridRowClickEventArgs<PersistentVolumeViewModel> args)
    {
