...
public partial class EventView : BaseView
{
    ...
    {
        Dispatcher.Dispatch(new FetchKubernetesEventsAction(Tab, NamespacesState.Value.SelectedNamespaces, _cancellationTokenSource.Token));
    }

    private async Task ContextMenuClick(DataGridRowClickEventArgs<EventsViewModel> args)
    {
