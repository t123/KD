...
public partial class ValidatingWebhookConfigurationView : BaseView
{
    ...
    protected override void OnInitialized()
    {
        ...
        Dispatcher.Dispatch(new FetchKubernetesValidatingWebhookConfigurationAction(Tab, NamespacesState.Value.SelectedNamespaces, _cancellationTokenSource.Token));
    }
}