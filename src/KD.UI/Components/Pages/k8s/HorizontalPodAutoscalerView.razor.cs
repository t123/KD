...
public partial class HorizontalPodAutoscalerView : BaseView
{
    private HorizontalPodAutoscalerViewModel _contextRow;
    ...
    protected override void OnInitialized()
    {
        ...
        _refreshAction = () => Dispatcher.Dispatch(new FetchKubernetesHorizontalPodAutoscalerAction(Tab, NamespacesState.Value.SelectedNamespaces, _cancellationTokenSource.Token));
    ...
    private void OpenProperties(HorizontalPodAutoscalerViewModel viewModel)
    {
        Dispatcher.Dispatch(new OpenPropertiesAction(_cancellationTokenSource.Token));
        Dispatcher.Dispatch(new FetchKubernetesHorizontalPodAutoscalerPropertyAction(Tab, viewModel.Name, viewModel.Namespace, _cancellationTokenSource.Token));
    }

    protected async Task ContextMenuClick(DataGridRowClickEventArgs<HorizontalPodAutoscalerViewModel> args)
    {
