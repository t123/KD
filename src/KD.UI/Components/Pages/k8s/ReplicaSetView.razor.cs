...
public partial class ReplicaSetView : BaseView
{
    ...
    {
        Dispatcher.Dispatch(new FetchKubernetesReplicaSetAction(Tab, NamespacesState.Value.SelectedNamespaces, _cancellationTokenSource.Token));
    }

    private async Task ContextMenuClick(DataGridRowClickEventArgs<ReplicaSetViewModel> args)
    {
